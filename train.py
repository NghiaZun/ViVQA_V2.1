...
def main():
    ...
    for epoch in range(total_epochs):
        ...
        print(f"  LR: {current_lr:.6f}, KL weight: {kl_weight * 0.03:.4f} (raw={kl_weight:.1f}), Stage: {current_stage}")
        ...
        # 🚨 REMOVED: scheduler.step() đã gọi trong run_one_epoch()
        curriculum.step()  # Only step curriculum per epoch
        print()
