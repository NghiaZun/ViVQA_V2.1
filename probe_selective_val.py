...
te = pd.read_csv('archive/val_split.csv')
...
base = pd.read_csv('analysis/valoracle/val_base.csv')      # de lay nhan dung/sai cua he da trien khai
...
d = pd.DataFrame(rows); d.to_csv('analysis/valoracle/val_selective.csv', index=False)
print(f'\nda luu analysis/valoracle/val_selective.csv ({len(d)} dong)')
